...
namespace EtherpunkManagementSystems.Data
{
    public class EtherpunkDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(Microsoft.EntityFrameworkCore.ModelBuilder builder)
        {
            ...
            builder.Entity<ApplicationRole>().HasData(Entities.Roles.Admin);
            builder.Entity<ApplicationRole>().HasData(Entities.Roles.Superviser);
            builder.Entity<ApplicationRole>().HasData(Entities.Roles.Tech);
            builder.Entity<ApplicationRole>().HasData(Entities.Roles.User);
    ...
    public class HardwareInventory
    {
        ...
        public string Notes { get; set; }
        public string ShortId { get; set; } = Misc.GenerateNewUId("EI-", 9);
